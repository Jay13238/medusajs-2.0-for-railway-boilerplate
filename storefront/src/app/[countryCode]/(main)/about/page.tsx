...
export const metadata: Metadata = {
  title: "About | Preperation Ministry",
  ...
  return (
    <div className="pt-24 max-w-lg w-full px-6 md:px-0 md:mx-auto">
      ...
      <p className="mb-10 text-primary">
        The Preparation Ministry is a self-supporting ministry dedicated to
        partnering with its local conference to reach people through public
        seminars and visual media. Over the past 11 years, God has abundantly
        blessed our efforts, allowing us to minister to more than 70 churches.
        Our sermons and health programs have been broadcast on five different
        Christian TV channels, expanding our outreach to a broader audience.
        <br />
        <br />
